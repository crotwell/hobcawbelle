...
export function do_help(pageState: PageState) {
  ...
  <article class="help">
    ...
    <h5>Earthquakes</h5>
    <p>
    Lists all earthquakes for the Lugoff-Elgin sequence, starting with
    the first magnitude 3.3 event on 2021-12-27. Clicking an earthquake
    ...
    the seismograms for that earthquake at the JKYD, BARN and JSC stations.
    Note that JKYD was installed on 2022-10-18 so any earthquakes prior
    to that date will not have any data from JKYD.
    <p>
    <h5>Seismograph</h5>
    <p>
    Displays seismograms either for a selected earthquake, or for the most recent
    5 minutes of data. By default it shows seismograms from JKYD, BARN and JSC.
    ...
    Because an actual display of a HH? channel at 100 samples per second
    ...
    The default is the Z component at JKYD, but other stations and channels
    ...
    covering much more than a day as the volume of data may be very large.
    </p>
    <h5>Realtime</h5>
    <p>
